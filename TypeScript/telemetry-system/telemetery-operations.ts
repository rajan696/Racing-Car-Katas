...
export default class TelemetryOperation {
    ...
    receive() {
        ...
        if (typeof (this._diagnosticMessageResult) === 'undefined' || this._diagnosticMessageResult === '') {
            ...
            message = '';
            var messageLength = this.dataHelper._connectionEventsSimulator(50, 110);
            for (var i = messageLength; i >= 0; --i) {
                message += this.dataHelper._connectionEventsSimulator(40, 126).toString();
            }
        }
        else {
